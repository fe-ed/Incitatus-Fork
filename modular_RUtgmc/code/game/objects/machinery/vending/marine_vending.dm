...
/obj/machinery/vending/weapon
	products = list(
		...
		"SMGs" = list(
			...
			/obj/item/weapon/gun/smg/p19bizon = 3,
			/obj/item/ammo_magazine/smg/p19 = -1,
		),
		"Marksman" = list(
		...
		"Shotgun" = list(
			...
			/obj/item/ammo_magazine/rifle/tx15_buckshot = -1,
			/obj/item/ammo_magazine/rifle/tx15_flechette = -1,
			/obj/item/ammo_magazine/rifle/tx15_slug = -1,
			/obj/item/ammo_magazine/rifle/tx15_incendiary = 5,
			/obj/item/weapon/gun/rifle/standard_autoshotgun/jackhammer = 3,
			/obj/item/ammo_magazine/rifle/tx24_buckshot = -1,
			/obj/item/ammo_magazine/rifle/tx24_flechette = -1,
			/obj/item/ammo_magazine/rifle/tx24_slug = -1,
			/obj/item/ammo_magazine/rifle/tx24_incendiary = 5,
		...
		"Boxes" = list(
			...
			/obj/item/ammo_magazine/packet/standardautoshotgun/slug = -1,
			/obj/item/ammo_magazine/packet/standardautoshotgun/flechette = -1,
			/obj/item/ammo_magazine/packet/acp40 = -1,
			/obj/item/ammo_magazine/packet/acpl40 = -1,
			/obj/item/ammo_magazine/packet/p9x18 = -1,
			/obj/item/ammo_magazine/packet/p4570 = -1,
...
/obj/machinery/vending/weapon/crash
	products = list(
		...
		"SMGs" = list(
			...
			/obj/item/ammo_magazine/smg/mp7_new = -1,
			/obj/item/weapon/gun/smg/p19bizon = 1,
			/obj/item/ammo_magazine/smg/p19 = -1,
		),
		"Marksman" = list(
			/obj/item/weapon/gun/rifle/standard_dmr = -1,
		...
		"Shotgun" = list(
			...
			/obj/item/ammo_magazine/rifle/tx15_flechette = -1,
			/obj/item/ammo_magazine/rifle/tx15_slug = -1,
			/obj/item/weapon/gun/rifle/standard_autoshotgun/jackhammer = 1,
			/obj/item/ammo_magazine/rifle/tx24_buckshot = -1,
			/obj/item/ammo_magazine/rifle/tx24_flechette = -1,
			/obj/item/ammo_magazine/rifle/tx24_slug = -1,
			/obj/item/weapon/gun/shotgun/double/marine = -1,
...
/obj/machinery/vending/weapon/valhalla
	products = list(
		...
		"Shotgun" = list(
			...
			/obj/item/ammo_magazine/rifle/tx15_flechette = -1,
			/obj/item/ammo_magazine/rifle/tx15_slug = -1,
			/obj/item/ammo_magazine/rifle/tx15_incendiary = -1,
			/obj/item/weapon/gun/rifle/standard_autoshotgun/jackhammer = -1,
			/obj/item/ammo_magazine/rifle/tx24_buckshot = -1,
			/obj/item/ammo_magazine/rifle/tx24_flechette = -1,
			/obj/item/ammo_magazine/rifle/tx24_slug = -1,
			/obj/item/ammo_magazine/rifle/tx24_incendiary = -1,
			/obj/item/weapon/gun/shotgun/double/marine = -1,
