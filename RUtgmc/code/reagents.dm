...
/datum/reagent/xenojelly/on_mob_add(mob/living/L, metabolism)
...
/datum/reagent/xenojelly/on_mob_life(mob/living/L, metabolism)
...
/datum/reagent/xenojelly/on_mob_delete(mob/living/L, metabolism)
