...
/obj/machinery/telecomms/bus/preset_three
	id = "Bus 3"
	network = "tcommsat"
	freq_listening = list(FREQ_ALPHA, FREQ_BRAVO, FREQ_CHARLIE, FREQ_DELTA, FREQ_FOREIGN, FREQ_ECHO)
	autolinkers = list("processor3", "alpha", "bravo", "charlie", "delta", "foreign", "echo")
