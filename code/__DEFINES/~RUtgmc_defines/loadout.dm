...
GLOBAL_LIST_INIT(engineer_gear_listed_products, list(
	...
	/obj/item/storage/box/crate/sentry_sniper = list(CAT_ENGSUP, "SST-574 sniper sentry kit", 50, "blue"),
	/obj/item/storage/box/crate/sentry_shotgun  = list(CAT_ENGSUP, "SHT-573 shotgun sentry kit", 40, "blue"),
...
GLOBAL_LIST_INIT(commander_gear_listed_products, list(
	...
	/obj/item/storage/box/crate/minisentry = list(CAT_FCSUP, "ST-580 point defense sentry kit", 15, "yellow"),
		/obj/item/storage/box/crate/sentry_sniper = list(CAT_ENGSUP, "SST-574 sniper sentry kit", 18, "yellow"),
	/obj/item/storage/box/crate/sentry_shotgun  = list(CAT_ENGSUP, "SHT-573 shotgun sentry kit", 12, "yellow"),
...
GLOBAL_LIST_INIT(synthetic_gear_listed_products, list(
	...
	/obj/item/storage/box/crate/sentry_sniper = list(CAT_ENGSUP, "SST-574 sniper sentry kit", 35, "blue"),
	/obj/item/storage/box/crate/sentry_shotgun  = list(CAT_ENGSUP, "SHT-573 shotgun sentry kit", 25, "blue"),
