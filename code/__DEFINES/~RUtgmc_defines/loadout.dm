GLOBAL_LIST_INIT(engineer_gear_listed_products, list(
		...
		/obj/item/explosive/plastique/genghis_charge = list(CAT_ENGSUP, "EX-62 Genghis incendiary charge", 6, "orange"),
		/obj/item/detpack = list(CAT_ENGSUP, "Detonation pack", 2, "orange"),
